...
import lk.apiit.eirlss.bnco_vehicle_rental_backend.Booking.DTO.AvailableBookingItemsDTO;
...
public class BookingController {
    ...
    @RequestMapping(value = "/additemtobooking", method = RequestMethod.POST)
    public ResponseEntity<?> addItemToBooking(@RequestHeader(value = "Authorization") String token, @RequestBody AvailableBookingItemsDTO dto) throws Exception {
        Utils.checkToken(token);
        bookingService.addItemForBooking(dto);
        return ResponseEntity.ok("");
    }
}
